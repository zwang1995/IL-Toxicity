...
def Modeling(version, first_model, EPOCH):
    # Create floder
    ...
    print(f"Cross validation completed.\nThe hidden layer 1 and 2 have {n1_opt} and {n2_opt} neurons, respectively.")


if __name__ == "__main__":
    # This FNN.kFCV.py file is used to determined hyper-parameters of FNN models.
    version = "v1"
    ...
    Modeling(version, first_model, EPOCH)
